...
while(digitalRead(IRQ0)){}
  spiWrite16(ACCMODE_16, 0b00000000000100000); // chooses the wiring mode (delta/Wye, Blondel vs. Non-blondel) to push up in initial config, Need the other if statements for all configuration modes
