...
GPIO.setup(22, GPIO.OUT)  # Set GPIO pin 29 to output mode.
pwm = GPIO.PWM(22, 1000)   # Initialize PWM on pwmPin 100Hz frequency

# main loop of program
print("\nPress Ctl C to quit \n")  # Print blank line before and after message.
dc=0                               # set dc variable to 0 for 0%
pwm.start(dc)  
pwm.ChangeDutyCycle(30)                    # Start PWM with 0% duty cycle
